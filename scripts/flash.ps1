# flash.ps1 -- flash G0B1_Skeleton via STM32_Programmer_CLI (Nucleo-G0B1RE)
#
# Usage:
#   scripts\flash.ps1                        # flash Debug\G0B1_Skeleton.elf to the bench ST-Link
...
Write-Host "=== G0B1_Skeleton flash ($Config) ===" -ForegroundColor Cyan
