# build.ps1 -- headless STM32CubeIDE build for G0B1_Skeleton (Nucleo-G0B1RE)
#
# Usage:
...
$workspace = Join-Path $env:TEMP "g0b1_skeleton-headless-ws-$ts"
...
Write-Host "=== G0B1_Skeleton build ($Config) ===" -ForegroundColor Cyan
